...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            options={
                'indexes': [models.Index(fields=['user_id'], name='users_usera_user_id_269a60_idx'), models.Index(fields=['event_type'], name='users_usera_event_t_d9907f_idx'), models.Index(fields=['created_at'], name='users_usera_created_828ca1_idx')],
            },
        ),
    ]
