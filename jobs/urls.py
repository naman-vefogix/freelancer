...
urlpatterns = [
    path('', views.JobAPIView.as_view(), name='jobs_api'),
    path('<int:id>/', views.DetailJobAPIView.as_view(), name='jobs_detail_api'),
    path('<int:job_id>/apply/', views.ApplyJobAPIView.as_view(), name='apply_job_api'),
    path('<int:job_id>/applications/', views.ViewApplicationsAPIView.as_view(), name='view_applications_api'),
]
